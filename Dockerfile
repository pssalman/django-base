...
# Available Options - development, production, staging, testing and local
ARG ENV=local
ENV ENV ${ENV}
ARG PORT=8000
ENV PORT ${PORT}
...
COPY --chown=django:django ./environments/django/${ENV}/.env /app/environments/django/${ENV}/.env
